...
function darkMode() {
    ...
    if (css.getAttribute('href') === '/static/Cargos Desc/Dark Mode/dark.css') {
        css.setAttribute('href', '/static/Cargos Desc/Light Mode/light.css'); // Muda para o modo claro
        linhas.forEach(linha => linha.setAttribute('src', '/static/IMAGENS IGUAIS/Light Mode/3 linhas preto.png'));

    } else {
        css.setAttribute('href', '/static/Cargos Desc/Dark Mode/dark.css'); // Muda para o modo escuro
