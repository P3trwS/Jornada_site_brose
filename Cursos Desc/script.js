function darkMode() {
    ...
    if (css.getAttribute('href') === '/Jornada_site_brose/Cursos Desc/Dark Mode/dark.css') {
        css.setAttribute('href', '/Jornada_site_brose/Cursos Desc/Light Mode/light.css'); // Muda para o modo claro
        linhas.forEach(linha => linha.setAttribute('src', '/Jornada_site_brose/Cursos Desc/Light Mode/3 linhas preto.png'));

    } else {
        css.setAttribute('href', '/Jornada_site_brose/Cursos Desc/Dark Mode/dark.css'); // Muda para o modo escuro

        linhas.forEach(linha => linha.setAttribute('src', '/Jornada_site_brose/Cursos Desc/Dark Mode/3 linhas branco.png'));
