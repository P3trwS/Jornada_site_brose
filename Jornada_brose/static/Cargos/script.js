...
function darkMode() {
    ...
    if (css.getAttribute('href') === '/static/Cargos/Dark Mode/dark.css') {
        css.setAttribute('href', '/static/Cargos/Light Mode/light.css'); // Muda para o modo claro
        linhas.forEach(linha => linha.setAttribute('src', '/static/IMAGENS IGUAIS/Light Mode/3 linhas preto.png'));
        filtro.setAttribute('src', '/static/Cargos/Light Mode/settings.png')

    } else {
        css.setAttribute('href', '/static/Cargos/Dark Mode/dark.css'); // Muda para o modo escuro

        linhas.forEach(linha => linha.setAttribute('src', '/static/IMAGENS IGUAIS/Dark Mode/3 linhas branco.png'));
        filtro.setAttribute('src', '/static/Cargos/Dark Mode/settings branco.png')
