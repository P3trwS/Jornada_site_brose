...
function toggleEdit() {
    ...
    if (isEditing) {
        ...
        if (confirm("Deseja salvar as alterações?")) {
            ...
            if (css.getAttribute('href') === "/static/Funcionarios Desc/Light Mode/light.css") {
                editButton.src = "/static/Funcionarios Desc/Light Mode/user-avatar preto.png"; // Volta para o ícone de editar
                cancelButton.style.display = 'none'; // Esconde o botão de cancelar
            } else {
                editButton.src = "/static/Funcionarios Desc/Dark Mode/user-avatar branco.png"; // Volta para o ícone de editar
                cancelButton.style.display = 'none'; // Esconde o botão de cancelar
            }
        }
    } else {
...
function cancelEdit() {
    ...
    if (confirm("Tem certeza de que deseja cancelar as alterações?")) {
        ...
        if (css.getAttribute('href') === "/static/Funcionarios Desc/Light Mode/light.css") {
            ...
            editButton.src = "/static/Funcionarios Desc/Light Mode/user-avatar preto.png";
            cancelButton.style.display = 'none';
        } else {
            editButton.src = "/static/Funcionarios Desc/Dark Mode/user-avatar branco.png";
            cancelButton.style.display = 'none';
        }
    }
}
...
function darkMode() {
    ...
    if (css.getAttribute('href') === '/static/Funcionarios Desc/Dark Mode/dark.css') {
        css.setAttribute('href', '/static/Funcionarios Desc/Light Mode/light.css'); // Muda para o modo claro
        linhas.forEach(linha => linha.setAttribute('src', '/static/IMAGENS IGUAIS/Light Mode/3 linhas preto.png'));
        editButton.src = '/static/Funcionarios Desc/Light Mode/user-avatar preto.png'
        deletelButton.src = '/static/Funcionarios Desc/Light Mode/delete.png'

    } else {
        css.setAttribute('href', '/static/Funcionarios Desc/Dark Mode/dark.css'); // Muda para o modo escuro
        editButton.src = '/static/Funcionarios Desc/Dark Mode/user-avatar branco.png'
        linhas.forEach(linha => linha.setAttribute('src', '/static/IMAGENS IGUAIS/Dark Mode/3 linhas branco.png'));
        deletelButton.src = '/static/Funcionarios Desc/Dark Mode/delete-branco.png';
    }
}
